...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
        ...
        http.cors().configurationSource(corsConfigurationSource())
                ...
                .and()
                    ...
                    .antMatchers("/api/v1/posts/lists", "/api/v1/posts/post_idx", "/api/v1/posts/search", "/api/v1/posts/new",
                                "/v2/api-docs", "/swagger-resources/**","http://localhost:3000","http://52.79.235.223:80/articleDetail/*","http://52.79.235.223/articleDetail/*",
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList("http://localhost:3000","http://15.165.67.119:9000/api/v1/*","http://52.79.235.223:80/*", "http://52.79.235.223/*","http://52.79.235.223:80/articleDetail/*"));
