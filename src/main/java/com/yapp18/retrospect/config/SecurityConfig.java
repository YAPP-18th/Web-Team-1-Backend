...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().configurationSource(corsConfigurationSource())
                ...
                .and()
                    ...
                    .antMatchers("/login/oauth2/code/**", "/api/v1/auth/**", "/api/v1/spring/**", "/api/v1/user/find").permitAll()
                    ...
                    .antMatchers("/api/v1/posts/search", "/api/v1/posts/lists/**","/api/v1/posts/lists/new",
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList("http://localhost:3000","http://15.165.67.119:9000/api/v1/*","http://52.79.235.223:80","*"));
